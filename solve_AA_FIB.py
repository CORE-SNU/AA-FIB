...
if len(sys.argv) == 6 or len(sys.argv) == 7:
    ...
    memory = [4,8,12,16]
    flag = [True]
    alg_names = ["A3" + sys.argv[1] + "_" + str(mem) for mem in memory] # Just FIB & A3FIB_memorysize
            ...
            for init in flag:
                ...
                for m_idx, mem in enumerate(memory):
                    if algo == "A3FIB":
                        ...
                        solver = A3FIB(pomdp, precision, mem = mem, sample = sample, initial_vector = initial_vector, lamb_ = lamb_)    # Effective solver
                        if sample:
                    ...
                    dict_statistics[algo_current][5].append(solver.res)
